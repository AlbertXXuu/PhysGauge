...
body{min-width:0}.brand-link{min-height:44px;align-items:center}.nav-button{min-height:44px;transition:background-color 300ms var(--ease),color 300ms var(--ease),box-shadow 300ms var(--ease)}.liquid-button{transition:transform 420ms var(--ease),border-color 420ms var(--ease),background-color 420ms var(--ease),box-shadow 420ms var(--ease)}.text-button{min-height:44px;padding:8px 4px}.liquid-button:focus-visible,.text-button:focus-visible,.nav-button:focus-visible,a:focus-visible{outline:3px solid rgb(37 99 235 / 45%)!important;outline-offset:4px!important}.hero-visual{min-width:0}.response-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin:28px 0 14px}.response-heading span{color:var(--muted);font-size:.72rem}.response-heading h2{margin:4px 0 0;font-size:clamp(1.45rem,2.4vw,2.25rem);font-weight:570;letter-spacing:-.025em}.response-plot{min-height:270px;padding:12px;border-radius:20px;background:linear-gradient(145deg,rgb(255 255 255 / 45%),rgb(219 231 255 / 48%));color:var(--muted)}.response-plot svg{display:block;width:100%;height:auto;overflow:visible}.response-grid{stroke:rgb(71 105 148 / 15%);stroke-width:1}.response-axis{stroke:rgb(71 105 148 / 32%);stroke-width:1.2}.response-line{fill:none;stroke:var(--violet);stroke-width:4;stroke-linecap:round;stroke-linejoin:round}.response-dot{fill:white;stroke:var(--violet);stroke-width:4}.response-value{fill:var(--primary);font:650 12px "Instrument Sans"}.response-tick{fill:var(--muted);font:600 11px "Instrument Sans"}.response-points{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:12px}.response-points span{display:grid;gap:2px;padding:8px 10px;border-radius:12px;background:rgb(255 255 255 / 52%);color:var(--muted);font-size:.68rem;overflow-wrap:anywhere}.response-points strong{color:var(--primary);font-size:.78rem}.visual-explainer{margin:18px 0 0;color:var(--reading);font-size:.82rem;line-height:1.55}
.response-line.s0{stroke:#2563eb}.response-line.s1{stroke:#7c3aed;stroke-dasharray:9 6}.response-line.s2{stroke:#0891b2;stroke-dasharray:3 5}.response-line.s3{stroke:#ea580c;stroke-dasharray:12 5 3 5}.response-dot.s0{stroke:#2563eb}.response-dot.s1{stroke:#7c3aed}.response-dot.s2{stroke:#0891b2}.response-dot.s3{stroke:#ea580c}.response-points{grid-template-columns:repeat(2,minmax(0,1fr))}.response-points strong{display:flex;align-items:center;gap:7px}.response-points strong i{width:18px;height:3px;border-radius:999px;background:#2563eb}.response-points strong i.s1{background:#7c3aed}.response-points strong i.s2{background:#0891b2}.response-points strong i.s3{background:#ea580c}.response-points small{color:var(--muted);font-size:.62rem;line-height:1.45}
