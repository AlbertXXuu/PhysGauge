...
.disc.blue{animation:blue-collision 7.2s var(--ease) infinite}.disc.violet{animation:violet-collision 7.2s var(--ease) infinite}.contact{animation:contact-flash 7.2s var(--ease) infinite}.track{animation:track-breathe 7.2s var(--ease) infinite}.visual-explainer{margin:18px 0 0;color:var(--reading);font-size:.82rem;line-height:1.55}@keyframes blue-collision{0%,18%{transform:translateY(-50%) translateX(0)}48%,58%{transform:translateY(-50%) translateX(58px)}78%,100%{transform:translateY(calc(-50% - 10px)) translateX(-16px)}}@keyframes violet-collision{0%,18%{transform:translateY(-50%) translateX(0)}48%,58%{transform:translateY(-50%) translateX(-58px)}78%,100%{transform:translateY(calc(-50% + 10px)) translateX(16px)}}@keyframes contact-flash{0%,43%,66%,100%{opacity:.28;transform:translate(-50%,-50%) scale(.7)}50%,58%{opacity:1;transform:translate(-50%,-50%) scale(1.55);box-shadow:0 0 36px rgb(79 70 229 / 45%)}}@keyframes track-breathe{0%,100%{opacity:.48}50%{opacity:1}}
...
@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}.liquid-button,.liquid-button::before,.nav-button{transition:none}.disc,.contact,.track{animation:none}}
"""
